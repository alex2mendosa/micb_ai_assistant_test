...
try:
    from __config import embedding_main, llm, vector_store_fin_law_hq, vector_store_fin_law
...
os.system("jupyter nbconvert --to script __app.ipynb")


# In[3]:


#!streamlit run __app.py
